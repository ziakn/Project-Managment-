            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="changepassword"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
        ...
        <div id="page-wrapper">
            ...
            <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class="fa fa-bar-chart-o fa-fw"></i> Requested Project
    ...
    <tr>  <!--
       ...
       -->   
        ...
        <td><?php echo $row['area'];?></td>
           ...
           <!-- here is the codding to view the project detail of the student button-->
          <td>
          <button type="button" class="btn btn-outline btn-default" data-toggle="modal" data-target="#viewModal-<?php echo $row['prefrencetwo_id'] ?>" data-toggle="modal"><span class="glyphicon glyphicon-eye-open"></span> View </button>
