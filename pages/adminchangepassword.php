                ...
                <div class="col-lg-12">
                    <div class="panel panel-default">
                        ...
                        <div class="panel-body">
                           <form role="form" action="adminchangepasswordrefrence.php" method="POST">
                                        <?php
                               ...
                               while($row = mysql_fetch_array($result))
                               {
                                ?>
                                        <div class="form-group">
                                            <label>Name</label>
                                            <input class="form-control" disabled value="<?php echo $row['admin_name']; ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input class="form-control" type="password" required name="currentpassword" placeholder="Current Password">
