            ...
            <ul class="nav navbar-top-links navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-user">
                        <li><a href="changepassword.php"><i class="fa fa-user fa-fw"></i> User Profile</a>
                        </li>
                            ...
                            <div class="tab-content">
                                ...
                                <!-- Id demo is diplaying date in javascript coding below in the page -->
                                    ...
                                    <p>
                                        ...
                                        <form action="studentprogressupdate.php" method="POST">
                                    ...
                                    <div id="collapseOne" class="panel-collapse collapse in">
                                        <div class="panel-body">
                                           <form action="studenttaskprogress.php" method="POST">
                                              ...
                                              <div class="modal-dialog" role="document">
                                                  <div class="modal-content">
                                                      ...
                                                      &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
                                                          ...
                                                          <form action="totalmarks.php" method="POST">
